...
internal static class FormidableEngineFactory
{
    ...
    /// Internal rather than private: the component-side diagnostics resolve their own logger the
    /// identical way, through this one method, so the "Formidable" category name has a single home
