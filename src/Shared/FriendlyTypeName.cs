...
/// <c>GetType().Name</c> would say "FormidableFieldMessage`1" rather than "FormidableFieldMessage".
/// Compiled into both <c>Formidable.Blazor</c> and <c>Formidable.AspNetCore</c> from this one
/// shared source file, so each assembly gets its own <see langword="internal"/> copy rather than
/// a shared reference.
/// </summary>
