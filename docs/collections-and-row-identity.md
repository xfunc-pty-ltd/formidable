...
fresh components for the replacement. Removing one disposes its components and builds nothing.
Adding or reordering disposes nothing at all, since a keyed diff permutes the components it already
